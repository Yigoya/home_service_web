...
const PreSignup = () => {
  ...
  return (
    <div className="min-h-screen lg:mt-5 flex items-center justify-center  bg-cover bg-center px-4 " style={{ backgroundImage: `url(${cleanImage})` }} px-4>
      <div className="w-full max-w-2xl p-8 bg-white rounded-xl shadow-lg">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">HuluMoya</h1>
