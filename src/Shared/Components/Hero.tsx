          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="mt-10">
              <div className={`relative max-w-xl mx-auto transform transition-all duration-300 ${isFocused ? 'scale-105' : ''}`}>
                <div className="absolute inset-0 bg-blue-500 rounded-lg opacity-10 blur-lg transition-opacity duration-300"></div>
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-32 py-4 bg-white rounded-lg shadow-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                  />
                  <button className="absolute right-2 bg-blue-600 text-white px-6 py-2 rounded-md flex items-center gap-2 hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl">
