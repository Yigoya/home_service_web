...
export default function LocationSelector({ initialLocation = "", onLocationSelect }) {
  // State for location
  const [location, setLocation] = useState(initialLocation || "Bole, Addis Ababa")
  ...
  const selectLocation = (loc) => {
    navigate(`/search?locationQuery=${loc.name}`)
            ...
            <button
              ...
              onClick={() => {
                navigator.geolocation.getCurrentPosition(
                  (position) => {
                    const currentLocation = "Current Location, Addis Ababa"
