              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-2 border ${errors.reason ? 'border-red-300' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500`}
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className={`block w-full pl-10 pr-3 py-2 border ${errors.state ? 'border-red-300' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500`}
